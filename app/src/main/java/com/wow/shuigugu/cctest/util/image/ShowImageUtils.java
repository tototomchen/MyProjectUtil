package com.wow.shuigugu.cctest.util.image;
...
public class ShowImageUtils {
    ...
    public static void showImageView(Context context, int errorimg, String url,View view){
        if(view instanceof ImageView){
            showImageView(context, errorimg, url,(ImageView) view);
        }else if(view instanceof LinearLayout){
            showImageView(context, errorimg, url,(LinearLayout) view);
        }else if(view instanceof RelativeLayout){
            showImageView(context, errorimg, url,(RelativeLayout) view);
        }else if(view instanceof FrameLayout){
            showImageView(context, errorimg, url,(FrameLayout) view);
        }else if(view instanceof TextView){
            showImageView(context, errorimg, url,(TextView) view);
        }
    }
    /**
     * (1)
     ...
     * @param imgeview 组件
     */
    private static void showImageView(Context context, int errorimg, String url,
                                     ImageView imgeview) {
    ...
    private static void showImageViewBlur(Context context, int errorimg,
